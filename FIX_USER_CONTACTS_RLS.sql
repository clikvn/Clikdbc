-- Fix RLS policies for user_contacts table
-- The issue: Policies are trying to access auth.users table which requires elevated permissions
-- Solution: Use auth.uid() directly and convert to user_code format
