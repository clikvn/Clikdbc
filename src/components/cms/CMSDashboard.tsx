...
import { saveBusinessCardData, loadBusinessCardData, exportData, importData } from "../../utils/storage";
import { Home, Mail, FileText, Briefcase, Sparkles, ArrowRight, ChevronLeft, Menu, X, Plus, Copy, ThumbsUp, ThumbsDown, Paperclip, Camera, MessageCircle, Trash2, Share2, LogOut } from "lucide-react";
